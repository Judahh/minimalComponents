...
export const MilkBar = ({ min=0, max=1, fillColor='#000000', time=1, id=0, styles={}, quantity=1}) => (
  <>
    <SVG style={styles}>
      <linearGradient id={'lg' + id} x1="0.5" y1="1" x2="0.5" y2="0">
        ...
        <stop offset={max} stopOpacity="1" stopColor={fillColor}>
          <animate attributeName="offset" from={min} to={max} dur={time + 's'} begin="0s"/>
        </stop>
